...
<body>
  ...
  <div id="app">
    ...
    <form id="forms" action="./conexaologin.php" method="post" onsubmit="exibirAlerta(event)">
      ...
      <input type="text" maxlength="42" id="nome" name="usuario" placeholder="Digite seu e-mail ou código de acesso." required onfocus="this.placeholder = ''" onblur="this.placeholder = 'Digite seu E-mail / CPF / ID'" style="text-align: left;"><br>
